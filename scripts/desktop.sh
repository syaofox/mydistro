...
installdwmapps() {
    ...
    sudo pacman -S --noconfirm nautilus  ark feh jq volumeicon blueberry xfce4-power-manager xfce4-screenshooter eog gnome-calculator parcellite numlockx
